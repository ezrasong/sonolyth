...
class PreferencesTable extends Table with TableInfo {
  ...
  late final GeneratedColumn<String> crossfadeCurve = GeneratedColumn<String>(
      'crossfade_curve', aliasedName, false,
      type: DriftSqlType.string,
      requiredDuringInsert: false,
      defaultValue: Constant('equalPower'));
  @override
...
class PluginsTable extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
...
class TrackTrimTable extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  TrackTrimTable(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      'id', aliasedName, false,
      hasAutoIncrement: true,
      type: DriftSqlType.int,
  ...
  @override
  TrackTrimTable createAlias(String alias) {
    return TrackTrimTable(attachedDatabase, alias);
  }
}
...
class DatabaseAtV13 extends GeneratedDatabase {
  ...
  late final TrackTrimTable trackTrimTable = TrackTrimTable(this);
