              ...
              try {
                ...
                event.onLoad((event) async {
                  await audioPlayerNotifier.load(
                    event.data.tracks.cast<SonolythFullTrackObject>().toList(),
                    autoPlay: true,
                  ...
                  if (event.data.collection is SonolythSimpleAlbumObject) {
                    historyNotifier.addAlbums(
                        [event.data.collection as SonolythSimpleAlbumObject]);
                  } else {
                    historyNotifier.addPlaylists(
                        [event.data.collection as SonolythSimplePlaylistObject]);
                  }
                });
