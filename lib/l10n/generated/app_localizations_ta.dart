...
class AppLocalizationsTa extends AppLocalizations {
  ...
  String get u_love_spotube =>
      'நீங்கள் Sonolyth ஐ நேசிக்கிறீர்கள் என்பது எங்களுக்குத் தெரியும்';

  @override
  String get check_for_updates => 'புதுப்பிப்புகளைச் சரிபார்';

  @override
  String get about_spotube => 'Sonolyth பற்றி';
  ...
  String get spotube_description =>
      'Sonolyth, ஒரு லேசான, பல தளங்களில் இயங்கும், அனைவருக்கும் இலவசமான spotify கிளையன்ட்';
  ...
  String get encryption_failed_warning =>
      'Sonolyth உங்கள் தரவை பாதுகாப்பாக சேமிக்க குறியாக்கத்தைப் பயன்படுத்துகிறது. ஆனால் அவ்வாறு செய்ய முடியவில்லை. எனவே இது பாதுகாப்பற்ற சேமிப்பகத்திற்கு மாறும்\nநீங்கள் லினக்ஸ் பயன்படுத்துகிறீர்கள் என்றால், எந்த ரகசிய சேவையும் (gnome-keyring, kde-wallet, keepassxc போன்றவை) நிறுவப்பட்டுள்ளதா என்பதை உறுதிப்படுத்தவும்';
  ...
  String get help_project_grow_description =>
      'Sonolyth ஒரு திறந்த மூல திட்டம். திட்டத்திற்கு பங்களிப்பு செய்வதன் மூலம், பிழைகளைப் புகாரளிப்பதன் மூலம் அல்லது புதிய அம்சங்களைப் பரிந்துரைப்பதன் மூலம் இந்தத் திட்டம் வளர உதவலாம்.';
  ...
  String get enable_connect_description =>
      'மற்ற சாதனங்களிலிருந்து Sonolyth ஐக் கட்டுப்படுத்தவும்';
  ...
  @override
  String get spotube_has_an_update => 'Sonolyth க்கு ஒரு புதுப்பிப்பு உள்ளது';
  ...
  String nightly_version(Object nightlyBuildNum) {
    return 'Sonolyth Nightly $nightlyBuildNum வெளியிடப்பட்டுள்ளது';
  }

  @override
  String release_version(Object version) {
    return 'Sonolyth v$version வெளியிடப்பட்டுள்ளது';
  }
  ...
  String count_plays(int count) {
    ...
    return '$countString முறை இசைக்கப்பட்டது';
  }
  ...
  String count_mins(int minutes) {
    ...
    return '$minutesString நிமிடங்கள்';
  }
