...
class AppLocalizationsBn extends AppLocalizations {
  ...
  @override
  String get u_love_spotube => 'আমরা জানি আপনি Sonolyth কে ভালবাসেন';

  @override
  String get check_for_updates => 'আপডেট চেক করুন';

  @override
  String get about_spotube => 'Sonolyth সম্পর্কে বিস্তারিত';
  ...
  String get spotube_description =>
      'Sonolyth, একটি কর্মদক্ষ, ক্রস-প্ল্যাটফর্ম, বিনামূল্যের জন্য Spotify ক্লায়েন্ট';
  ...
  String get enable_connect_description =>
      'অন্যান্য ডিভাইস থেকে Sonolyth নিয়ন্ত্রণ করুন';
  ...
  String count_plays(int count) {
    ...
    return '$countString বার প্লে হয়েছে';
  }
