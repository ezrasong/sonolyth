...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get about_spotube => 'About Sonolyth';
  ...
  String get enable_connect_description =>
      'Control Sonolyth from other devices';
  ...
  @override
  String get spotube_has_an_update => 'Sonolyth has an update';
  ...
  String nightly_version(Object nightlyBuildNum) {
    return 'Sonolyth Nightly $nightlyBuildNum has been released';
  }

  @override
  String release_version(Object version) {
    return 'Sonolyth v$version has been released';
  }
  ...
  String count_plays(int count) {
    ...
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$countString play',
    );
    return '$_temp0';
  }

  @override
  String get streaming_fees_hypothetical => 'Streaming fees';
  ...
  String count_mins(int minutes) {
    ...
    String _temp0 = intl.Intl.pluralLogic(
      minutes,
      locale: localeName,
      other: '$minutesString mins',
      one: '$minutesString min',
    );
    return '$_temp0';
  }
