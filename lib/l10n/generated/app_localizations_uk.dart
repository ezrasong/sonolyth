...
class AppLocalizationsUk extends AppLocalizations {
  ...
  @override
  String get u_love_spotube => 'Ми знаємо, що ви любите Sonolyth';

  @override
  String get check_for_updates => 'Перевірити наявність оновлень';

  @override
  String get about_spotube => 'Про Sonolyth';
  ...
  String get spotube_description =>
      'Sonolyth, легкий, кросплатформовий, безкоштовний клієнт Spotify';
  ...
  String get download_agreement_3 =>
      'Я повністю усвідомлюю, що мій IP може бути заблокований на YouTube, і я не покладаю на Sonolyth або його власників/контрибуторів відповідальність за будь-які нещасні випадки, спричинені моїми діями.';
  ...
  String get encryption_failed_warning =>
      'Sonolyth використовує шифрування для безпечного зберігання ваших даних. Але не вдалося цього зробити. Тому він перейде до небезпечного зберігання\nЯкщо ви використовуєте Linux, переконайтеся, що у вас встановлено будь-який секретний сервіс (gnome-keyring, kde-wallet, keepassxc тощо)';
  ...
  String get choose_your_region_description =>
      'Це допоможе Sonolyth показати вам правильний контент\nдля вашого місцезнаходження.';
  ...
  String get help_project_grow_description =>
      'Sonolyth - це проект з відкритим кодом. Ви можете допомогти цьому проекту зростати, вносячи свій внесок у проект, повідомляючи про помилки або пропонуючи нові функції.';
  ...
  @override
  String get enable_connect_description => 'Керуйте Sonolyth з інших пристроїв';
  ...
  @override
  String get spotube_has_an_update => 'Sonolyth має оновлення';
  ...
  String nightly_version(Object nightlyBuildNum) {
    return 'Sonolyth Nightly $nightlyBuildNum було випущено';
  }

  @override
  String release_version(Object version) {
    return 'Sonolyth v$version було випущено';
  }
