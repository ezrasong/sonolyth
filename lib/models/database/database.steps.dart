...
// Hand-maintained after generation (see below): the historical schemas below
// reference enums that no longer exist in the app, so their recorded defaults
// are spelled as the literals those enums produced. Re-apply both edits after
// any `drift_dev schema steps` run.
...
class Shape19 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<bool> get cacheMusic =>
      columnsByName['cache_music']! as i1.GeneratedColumn<bool>;
  i1.GeneratedColumn<int> get crossfadeDuration =>
      columnsByName['crossfade_duration']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get crossfadeCurve =>
      columnsByName['crossfade_curve']! as i1.GeneratedColumn<String>;
}
...
i1.GeneratedColumn<int> _column_79(String aliasedName) =>
    i1.GeneratedColumn<int>('crossfade_duration', aliasedName, false,
        type: i1.DriftSqlType.int, defaultValue: const Constant(0));
i1.GeneratedColumn<String> _column_80(String aliasedName) =>
    i1.GeneratedColumn<String>('crossfade_curve', aliasedName, false,
        type: i1.DriftSqlType.string,
...
final class Schema12 extends i0.VersionedSchema {
  ...
  late final Shape16 pluginsTable = Shape16(
      ...
      alias: null);
  late final Shape20 trackTrimTable = Shape20(
      source: i0.VersionedTable(
        entityName: 'track_trim_table',
        withoutRowId: false,
        isStrict: false,
        tableConstraints: [],
        columns: [
...
class Shape20 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get leadMs =>
      columnsByName['lead_ms']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get tailMs =>
      columnsByName['tail_ms']! as i1.GeneratedColumn<int>;
...
i1.GeneratedColumn<int> _column_82(String aliasedName) =>
    i1.GeneratedColumn<int>('file_size', aliasedName, false,
        type: i1.DriftSqlType.int);
i1.GeneratedColumn<int> _column_83(String aliasedName) =>
    i1.GeneratedColumn<int>('lead_ms', aliasedName, false,
        type: i1.DriftSqlType.int, defaultValue: const Constant(0));
i1.GeneratedColumn<int> _column_84(String aliasedName) =>
    i1.GeneratedColumn<int>('tail_ms', aliasedName, false,
        type: i1.DriftSqlType.int, defaultValue: const Constant(0));
