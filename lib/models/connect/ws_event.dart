...
class WebSocketAddTrackEvent extends WebSocketEvent<SonolythFullTrackObject> {
  WebSocketAddTrackEvent(SonolythFullTrackObject data)
      : super(WsEvent.addTrack, data);

  WebSocketAddTrackEvent.fromJson(Map<String, dynamic> json)
      : super(
          WsEvent.addTrack,
          SonolythFullTrackObject.fromJson(
